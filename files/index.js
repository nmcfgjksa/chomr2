...
const UUID = process.env.UUID || 'f586c14a-4c7e-4620-ba3d-01675c6e1602'; //
const NEZHA_SERVER = process.env.NEZHA_SERVER || '';     
const NEZHA_PORT = process.env.NEZHA_PORT || '';                     //
const NEZHA_KEY = process.env.NEZHA_KEY || 'N9BVoBfucVIrIzCBt8';   //
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'zyhn.ccdfggh.us.kg';     //
const ARGO_AUTH = process.env.ARGO_AUTH || 'eyJhIjoiOWI0ZTBlMTgzNzBkN2E5ODA4ZDdkNThjNjE4OWNjZWIiLCJ0IjoiYTQzMWQzZTAtMWMyZS00YWJkLTg3OWItMTlmNzlhOGRlNGE3IiwicyI6IlpXRTVZbUUyTldFdE5tUTRPQzAwTURZMkxXRXlZVE10TkRsaFpUazVNbVEzTldFMCJ9';
